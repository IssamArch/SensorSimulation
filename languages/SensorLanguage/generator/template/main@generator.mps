          ...
          <node concept="2OqwBi" id="3jSYJW1D459" role="3clFbG">
            ...
            <node concept="liA8E" id="3jSYJW1D4XE" role="2OqNvi">
              ...
              <node concept="Xl_RD" id="3jSYJW1D5Dq" role="37wK5m">
                <property role="Xl_RC" value=" public static Measurement createCSVLow(final String path,int n_sensor,int n_value,int n_time,int n_offset,int t) {" />
              </node>
            </node>
          </node>
        </node>
          ...
          <node concept="2OqwBi" id="3jSYJW1DGCU" role="3clFbG">
            ...
            <node concept="liA8E" id="3jSYJW1DHED" role="2OqNvi">
              ...
              <node concept="Xl_RD" id="3jSYJW1DHFu" role="37wK5m">
                <property role="Xl_RC" value="          return new Measurement&lt;&gt;(ligne.get(n_sensor).trim(),Long.parseLong(ligne.get(n_time).trim()),Integer.parseInt(ligne.get(n_value).trim()) + n_offset);" />
              </node>
            </node>
          </node>
        </node>
          ...
          <node concept="2OqwBi" id="3jSYJW1C2E9" role="3clFbG">
            ...
            <node concept="liA8E" id="3jSYJW1C3u$" role="2OqNvi">
              ...
              <node concept="Xl_RD" id="3jSYJW1C3_N" role="37wK5m">
                <property role="Xl_RC" value="public static Measurement createfilelow(final String file,int n_sensor,int n_value,int n_time,String dataSource,int n_offset,int t){" />
              </node>
            </node>
          </node>
        </node>
          ...
          <node concept="2OqwBi" id="3hswruZC_V9" role="3clFbG">
            ...
            <node concept="liA8E" id="3hswruZCAgp" role="2OqNvi">
              ...
              <node concept="3cpWs3" id="3hswruZDd3u" role="37wK5m">
                ...
                <node concept="Xl_RD" id="3hswruZCAgV" role="3uHU7B">
                  <property role="Xl_RC" value=" nameLot" />
                  <node concept="17Uvod" id="3hswruZDlru" role="lGtFl">
                    <property role="P4ACc" value="f3061a53-9226-4cc5-a443-f952ceaf5816/1070475926800/1070475926801" />
                    <property role="2qtEX9" value="value" />
                    <node concept="3zFVjK" id="3hswruZDlrv" role="3zH0cK">
                      <node concept="3clFbS" id="3hswruZDlrw" role="2VODD2">
                        <node concept="3clFbF" id="3hswruZDm5f" role="3cqZAp">
                          <node concept="2OqwBi" id="3hswruZDmiQ" role="3clFbG">
                            <node concept="30H73N" id="3hswruZDm5e" role="2Oq$k0" />
                            <node concept="3TrcHB" id="3hswruZDmyK" role="2OqNvi">
                              <ref role="3TsBF5" to="tpck:h0TrG11" resolve="name" />
                            </node>
                          </node>
                        </node>

...
public class map_App {
  public static void main(String[] args) {
    ...
    System.out.println("import java.util.HashMap;");
    System.out.println("import org.json.simple.JSONArray;");
    ...
    System.out.println(" ");
    System.out.println(" public static Measurement createCSVLow(final String path,String n_sensor,String n_value,String n_time,int n_offset,int t) {");
    ...
    System.out.println("           System.out.println(\"      new measurement for \" + ligne.get(Integer.parseInt(n_sensor)).trim() + \" from file csv law !\" );");
    System.out.println("          return new Measurement<>(ligne.get(Integer.parseInt(n_sensor)).trim(),Long.parseLong(ligne.get(Integer.parseInt(n_time)).trim()),Integer.parseInt(ligne.get(Integer.parseInt(n_value)).trim()) + n_offset);");
    ...
    System.out.println("  ");
    System.out.println("     public static Measurement createJSONLow(final String path,String n_sensor,String n_value,String n_time,int n_offset,int t) {");
    System.out.println("     try {");
    System.out.println("         JSONParser parser = new JSONParser();");
    System.out.println("         JSONArray jsonArray = (JSONArray) parser.parse(new FileReader(path));");
    System.out.println("         if(t >= 0 && t <= jsonArray.size() - 1) {");
    System.out.println("            Object o = jsonArray.get(t);");
    System.out.println("            JSONObject person = (JSONObject) o;");
    System.out.println("            String sensorName = (String) person.get(n_sensor);");
    System.out.println("            Object value = (Object) person.get(n_value);");
    System.out.println("            Long time = (Long) person.get( n_time);");
    System.out.println("            System.out.println(\"      new measurement for \" + n_sensor + \" from file json law !\" );");
    System.out.println("           return new Measurement<>(sensorName,time,value);");
    System.out.println("         }");
    ...
    System.out.println("public static Measurement createfilelow(final String file,String n_sensor,String n_value,String n_time,String dataSource,int n_offset,int t){");
    ...
    System.out.println("              Measurement measurement1 =createJSONLow(file,n_sensor,n_value,n_time,n_offset,t) ;");
    System.out.println("              return measurement1;");
    ...
    System.out.println("      Random random = new Random();");
    System.out.println("      int randomNumber = random.nextInt(duration * 2 +1  - 0) + 0;");
    System.out.println("      return randomNumber;");
    System.out.println("   }");
    System.out.println("   else if(risque == \"average\") {");
    System.out.println("      Random random = new Random();");
    System.out.println("      int randomNumber = random.nextInt(duration  +1  - 0) + 0;");
    System.out.println("      return randomNumber;");
    System.out.println("   }");
    System.out.println("   else if(risque ==  \"strong\"){");
    System.out.println("      Random random = new Random();");
    System.out.println("       int randomNumber = random.nextInt((duration/2)  - 0) + 0;");
    System.out.println("       return randomNumber;");
    System.out.println("   }");
    ...
    System.out.println("   if(risque == \"strong\" && monkey){");
    System.out.println("     Random random = new Random();");
    System.out.println("     int randomNumber = random.nextInt(nbrSensor * 2 +1  - 0) + 0;");
    System.out.println("     size =  randomNumber;");
    System.out.println("   }");
    System.out.println("   else if(risque == \"average\" && monkey) {");
    System.out.println("      Random random = new Random();");
    System.out.println("      size = random.nextInt(nbrSensor  +1  - 0) + 0;");
    System.out.println("   }");
    System.out.println("    else if(risque ==  \"low\" && monkey){");
    System.out.println("       Random random = new Random();");
    System.out.println("       size= random.nextInt((nbrSensor/2)  - 0) + 0;");
    System.out.println("    }");
    System.out.println("     for (int i =0; i< size;i++){");
    System.out.println("     Random random = new Random();");
    System.out.println("     temp.add(random.nextInt(nbrSensor +1  - 0) + 0);");
    System.out.println("    }");
    ...
    System.out.println("             if(t ==k && gorilla_Exist == true){");
    ...
    System.out.println("         Thread " + "jardinCsv" + " = new Thread(\"" + "jardinCsv" + "\") { ");
    System.out.println("         public void run(){");
    System.out.println("          int dureeMaxi = 0;");
    System.out.println("          try {");
    ...
    System.out.println("              sensName =\"" + " jardinCsv" + "\"+Integer.toString(i);");
    System.out.println("              Measurement measurement ;");
    System.out.println("              if( listeMonkey.contains(i)){");
    System.out.println("                   measurement = null;");
    System.out.println("                   System.out.println(\" monkey attaque sensor num! \"+ i);");
    ...
    System.out.println("         }");
    System.out.println("     };");
    System.out.println("    " + "jardinCsv" + ".start();");
    System.out.println(" ");
    ...
    System.out.println("         Thread " + "salleFunction" + " = new Thread(\"" + "salleFunction" + "\") { ");
    System.out.println("         public void run(){");
    System.out.println("          int dureeMaxi = 0;");
    System.out.println("          try {");
    System.out.println("            while (gorilla == false && dureeMaxi < " + 10 + ") { ");
    ...
    System.out.println("              sensName =\"" + " salleFunction" + "\"+Integer.toString(i);");
    ...
    System.out.println("         }");
    System.out.println("     };");
    System.out.println("    " + "salleFunction" + ".start();");
    System.out.println(" ");
    ...
    System.out.println("             listMarkov.add(new Pair<String, String>(" + "\"" + "sunny" + "\",\"" + "0.05" + "\"));");
    System.out.println("             listMarkov.add(new Pair<String, String>(" + "\"" + "runny" + "\",\"" + "0.4" + "\"));");
    System.out.println("             listMarkov.add(new Pair<String, String>(" + "\"" + "runny" + "\",\"" + "0.4" + "\"));");
    System.out.println("             listMarkov.add(new Pair<String, String>(" + "\"" + "runny" + "\",\"" + "0.2" + "\"));");
    System.out.println("             listMarkov.add(new Pair<String, String>(" + "\"" + "cloudy" + "\",\"" + "0.4" + "\"));");
    System.out.println("             listMarkov.add(new Pair<String, String>(" + "\"" + "cloudy" + "\",\"" + "0.5" + "\"));");
    System.out.println("             listMarkov.add(new Pair<String, String>(" + "\"" + "cloudy" + "\",\"" + "0.1" + "\"));");
    System.out.println("              Measurement measurement ;");
    System.out.println("              if( listeMonkey.contains(i)){");
    System.out.println("                   measurement = null;");
    System.out.println("                   System.out.println(\" monkey attaque sensor num! \"+ i);");
    System.out.println("               } else {");
    System.out.println("              measurement = createMarkovLow(sensName,listMarkov,t);");
    System.out.println("             }");
